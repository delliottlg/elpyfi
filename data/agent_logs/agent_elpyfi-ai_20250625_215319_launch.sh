#!/bin/bash
cd "/Users/d/Documents/projects/elpyfi-pm-claude/worktrees/elpyfi-ai_elpyfi-ai_20250625_215319"
...
cat << 'EOF' | claude \
     \
    2>&1 | tee "/Users/d/Documents/projects/elpyfi-pm-claude/data/agent_logs/agent_elpyfi-ai_20250625_215319.log"
